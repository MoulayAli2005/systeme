...
export async function GET() {
  return json({
    ...
    paths: {
      ...
      "/automations": { get: { summary: "List automations", tags: ["Automations"], security }, post: { summary: "Create WHEN/THEN rule", tags: ["Automations"], security } },
      "/automations/{id}": { patch: { summary: "Update or toggle a rule", tags: ["Automations"], security }, delete: { summary: "Delete a rule", tags: ["Automations"], security } },
      "/automations/{id}/runs": { get: { summary: "Recent automation runs", tags: ["Automations"], security } },
